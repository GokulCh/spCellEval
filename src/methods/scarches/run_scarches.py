"""scArches-compatible label transfer via scanpy ingest."""
...
from reference_mapping import run_kfold_label_transfer, scarches_predict  # noqa: E402

parser = argparse.ArgumentParser(description="scArches-style label transfer on k-fold splits.")
